...
class RecorderSession:
    def __init__(self, pi_recorder: PiRecorder, session_name: str, sensor_type: str, sample_rate_hz: float) -> None:
    ...
    def start(self, script: str, args: Iterable[str] | None = None):
        self.session_dir.mkdir(parents=True, exist_ok=True)
        return self.pi_recorder.start_logger(script, args)

    def save_rows(self, filename: str, headers: list[str], rows):
